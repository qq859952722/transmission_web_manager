...
TWC.uiLayout = (function() {
    ...
    function renderToolbar() {
        return '<div class="twc-toolbar">' +
            ...
            '</button>' +
            '<button class="twc-btn" id="btn-start" title="' + TWC.i18n.t('toolbar.start') + ' (Ctrl+S)" disabled>' +
            '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="5,3 19,12 5,21"/></svg>' +
            '</button>' +
            '<button class="twc-btn" id="btn-start-now" title="' + TWC.i18n.t('toolbar.start_now') + '" disabled>' +
            ...
            '</button>' +
            '<button class="twc-btn" id="btn-pause" title="' + TWC.i18n.t('toolbar.pause') + ' (Ctrl+D)" disabled>' +
            '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>' +
            '</button>' +
            '<button class="twc-btn" id="btn-reannounce" title="' + TWC.i18n.t('toolbar.reannounce') + '" disabled>' +
            ...
            '</button>' +
            '<button class="twc-btn" id="btn-verify" title="' + TWC.i18n.t('toolbar.verify') + '" disabled>' +
            '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>' +
            '</button>' +
            '<button class="twc-btn" id="btn-remove" title="' + TWC.i18n.t('toolbar.remove') + ' (Delete)" disabled>' +
            '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>' +
            '</button>' +
            '<div class="twc-separator"></div>' +
            '<button class="twc-btn" id="btn-queue-up" title="' + TWC.i18n.t('toolbar.queue_up') + '" disabled>' +
            '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="18 15 12 9 6 15"/></svg>' +
            '</button>' +
            '<button class="twc-btn" id="btn-queue-down" title="' + TWC.i18n.t('toolbar.queue_down') + '" disabled>' +
            '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg>' +
            '</button>' +
            '<button class="twc-btn" id="btn-queue-top" title="' + TWC.i18n.t('toolbar.queue_top') + '" disabled>' +
            '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 19V5M5 12l7-7 7 7"/></svg>' +
            '</button>' +
            '<button class="twc-btn" id="btn-queue-bottom" title="' + TWC.i18n.t('toolbar.queue_bottom') + '" disabled>' +
            '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 5v14M19 12l-7 7-7-7"/></svg>' +
            '</button>' +
            '<div class="twc-separator"></div>' +
            '<button class="twc-btn" id="btn-alt-speed" title="' + TWC.i18n.t('toolbar.alt_speed') + '">' +
            ...
            '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 4v6h6M23 20v-6h-6"/><path d="M20.49 9A9 9 0 0 0 5.64 5.64L1 10m22 4l-4.64 4.36A9 9 0 0 1 3.51 15"/></svg>' +
            '</button>' +
            '<button class="twc-btn twc-btn-icon" id="btn-auto-refresh" title="' + TWC.i18n.t('toolbar.auto_refresh') + '">' +
            '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>' +
            '</button>' +
            ...
            '</button>' +
            '<button class="twc-btn twc-btn-icon" id="btn-theme" title="' + TWC.i18n.t('toolbar.theme') + '">' +
    ...
    function renderDetailPanel() {
        return '<div class="twc-detail-panel" id="detail-panel">' +
            ...
            '<div class="twc-detail-tab active" data-tab="general">' + TWC.i18n.t('detail.tabs.general') + '</div>' +
            '<div class="twc-detail-tab" data-tab="files">' + TWC.i18n.t('detail.tabs.files') + '</div>' +
            '<div class="twc-detail-tab" data-tab="trackers">' + TWC.i18n.t('detail.tabs.trackers') + '</div>' +
            '<div class="twc-detail-tab" data-tab="peers">' + TWC.i18n.t('detail.tabs.peers') + '</div>' +
            '<div class="twc-detail-tab" data-tab="pieces">' + TWC.i18n.t('detail.tabs.pieces') + '</div>' +
            '<div class="twc-detail-tab" data-tab="speed">' + TWC.i18n.t('detail.tabs.speed') + '</div>' +
            '<div class="twc-detail-tab" data-tab="settings">' + TWC.i18n.t('detail.tabs.settings') + '</div>' +
            '<div style="flex:1"></div>' +
    ...
    function renderStatusBar() {
        return '<div class="twc-statusbar" id="statusbar">' +
            ...
            '<span id="stat-conn-text">' + TWC.i18n.t('status.connecting') + '</span>' +
            '</div>' +
            ...
            '<div class="twc-status-item" id="stat-error-count" title="' + TWC.i18n.t('filter.error') + '">' +
            ...
            '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>' +
            '<span id="stat-alt-speed-text" class="stat-alt-speed-off">' + TWC.i18n.t('dialog.settings.disabled') + '</span>' +
            '</div>' +
